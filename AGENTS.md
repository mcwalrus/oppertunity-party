...
| `pipeline/`                                 | Dagster code location — assets, jobs, schedules                    | —       |
| `pipeline/defs/assets/`                     | Dagster assets (ingestion, clean, site)                            | —       |
| `pipeline/defs/jobs.py`                     | Dagster job definitions                                            | —       |
